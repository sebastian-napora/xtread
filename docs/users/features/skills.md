...
> Create, manage, and share Skills to extend Xtread Code's capabilities.

This guide shows you how to create, use, and manage Agent Skills in **Xtread Code**. Skills are modular capabilities that extend the model's effectiveness through organized folders containing instructions (and optionally scripts/resources).

## Prerequisites

- Xtread Code (recent version)
- Basic familiarity with Xtread Code ([Quickstart](../quickstart.md))
...
- Extend Xtread Code for your workflows
...
Personal Skills are available across all your projects. Store them in `~/.xtread/skills/`:

```bash
mkdir -p ~/.xtread/skills/my-skill-name
```
...
Project Skills are shared with your team. Store them in `.xtread/skills/` within your project:
...
## Instructions
Provide clear, step-by-step guidance for Xtread Code.
...
Xtread Code currently validates that:
...
Xtread Code discovers Skills from:

- Personal Skills: `~/.xtread/skills/`
- Project Skills: `.xtread/skills/`
...
To view available Skills, ask Xtread Code directly:
...
cat ~/.xtread/skills/my-skill/SKILL.md
```
...
If Xtread Code doesn't use your Skill, check these common issues:
...
- Personal Skills: `~/.xtread/skills/<skill-name>/SKILL.md`
- Project Skills: `.xtread/skills/<skill-name>/SKILL.md`

```bash
# Personal
ls ~/.xtread/skills/my-skill/SKILL.md
...
Run Xtread Code with debug mode to see Skill loading errors:
...
1. Add the Skill under `.xtread/skills/`
2. Commit and push
3. Teammates pull the changes

```bash
git add .xtread/skills/
...
```bash
# Personal Skill
code ~/.xtread/skills/my-skill/SKILL.md

# Project Skill
code .xtread/skills/my-skill/SKILL.md
```

Changes take effect the next time you start Xtread Code. If Xtread Code is already running, restart it to load the updates.
