...
| Github Actions          | `V0.5.0`  | xtread-code-action and automation                         | Integrating Community Ecosystem | 1     |
...
| Tool: TextSearch        | `V0.0.8+` | Text search tool (grep, supports .xtreadignore)           | Coding Workflow                 | 1     |
