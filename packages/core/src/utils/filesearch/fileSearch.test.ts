...
describe('FileSearch', () => {
  ...
  it('should use .xtreadignore rules', async () => {
    ...
    expect(results).toEqual(['src/', '.xtreadignore', 'src/not-ignored.js']);
  });

  it('should combine .gitignore and .xtreadignore rules', async () => {
    tmpDir = await createTmpDir({
      '.gitignore': 'dist/',
      '.xtreadignore': 'build/',
