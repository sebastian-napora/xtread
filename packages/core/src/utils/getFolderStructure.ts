      ...
      if (entry.isFile()) {
        ...
        if (options.fileService) {
          const shouldIgnore =
            ...
            (options.fileFilteringOptions.respectXtreadIgnore &&
              options.fileService.shouldXtreadIgnoreFile(filePath));
          if (shouldIgnore) {
            continue;
          }
        }
      ...
      if (entry.isDirectory()) {
        ...
        if (options.fileService) {
          isIgnored =
            ...
            (options.fileFilteringOptions.respectXtreadIgnore &&
              options.fileService.shouldXtreadIgnoreFile(subFolderPath));
        }
