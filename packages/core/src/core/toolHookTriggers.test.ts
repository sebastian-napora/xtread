  ...
  describe('fireNotificationHook', () => {
    ...
    it('should send correct parameters to MessageBus for permission_prompt', async () => {
      ...
      await fireNotificationHook(
        mockMessageBus,
        'Xtread Code needs your permission to use Bash',
        NotificationType.PermissionPrompt,
        'Permission needed',
      );
      ...
      expect(mockMessageBus.request).toHaveBeenCalledWith(
        {
          ...
          input: {
            message: 'Xtread Code needs your permission to use Bash',
    ...
    it('should send correct parameters to MessageBus for idle_prompt', async () => {
      ...
      await fireNotificationHook(
        mockMessageBus,
        'Xtread Code is waiting for your input',
        NotificationType.IdlePrompt,
        'Waiting for input',
      );
      ...
      expect(mockMessageBus.request).toHaveBeenCalledWith(
        {
          ...
          eventName: 'Notification',
          input: {
            message: 'Xtread Code is waiting for your input',
