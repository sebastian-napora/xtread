...
1. Extract components from `vscode-ide-companion/src/webview/` into an independent `@xtread-code/webui` package
...
```typescript
// @xtread-code/webui/src/context/PlatformContext.ts
...
```javascript
// @xtread-code/webui/tailwind.preset.js
module.exports = {
  theme: {
    extend: {
      colors: {
...
module.exports = {
  ...
  content: [
    './src/**/*.{ts,tsx}',
    './node_modules/@xtread-code/webui/dist/**/*.js',
  ],
};
```
...
```
Developer ──► @xtread-code/webui ──► vscode-ide-companion
  │              │                      │
...
// After: Update import
import { FileIcon } from '@xtread-code/webui';
// or import { FileIcon } from '@xtread-code/webui/icons';
```
...
1. **Tailwind Class Name Tree Shaking**
   ...
   - Solution: Consumer's `content` config needs to include `node_modules/@xtread-code/webui`
...
│     └── Edit files in @xtread-code/webui/src/                     │
│                                                                  │
...
│     └── import { Component } from '@xtread-code/webui'            │
...
1. **Single Source of Truth**: All UI components live in `@xtread-code/webui`
