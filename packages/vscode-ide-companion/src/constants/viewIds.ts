 ...
 * `xtread-code:supportsSecondarySidebar` context key in package.json.
 ...
 */
export const CHAT_VIEW_ID_SIDEBAR = 'xtread-code.chatView.sidebar';
export const CHAT_VIEW_ID_SECONDARY = 'xtread-code.chatView.secondary';
