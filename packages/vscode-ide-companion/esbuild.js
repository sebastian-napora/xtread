...
async function main() {
  ...
  const webviewCtx = await esbuild.context({
    ...
    // @xtread-code/xtread-code-core is a peer dependency of @xtread-code/webui.
    // Since @xtread-code/webui marks it as external in its own Vite build, the
    ...
    // '@xtread-code/xtread-code-core/src/core/tokenLimits.js') are also excluded;
    ...
    external: ['@xtread-code/xtread-code-core', '@xtread-code/xtread-code-core/*'],
    logLevel: 'silent',
