...
describe('startupProfiler', () => {
  ...
  beforeEach(() => {
    resetStartupProfiler();
    vi.restoreAllMocks();
    saveEnv('XTREAD_CODE_PROFILE_STARTUP', 'SANDBOX');
    delete process.env['XTREAD_CODE_PROFILE_STARTUP'];
  ...
  function enableProfiler() {
    process.env['XTREAD_CODE_PROFILE_STARTUP'] = '1';
  ...
  describe('when outside sandbox (SANDBOX not set)', () => {
    it('should not enable profiler even with XTREAD_CODE_PROFILE_STARTUP=1', () => {
      process.env['XTREAD_CODE_PROFILE_STARTUP'] = '1';
      delete process.env['SANDBOX'];
  ...
  describe('when enabled (XTREAD_CODE_PROFILE_STARTUP=1 + SANDBOX)', () => {
    beforeEach(() => {
      enableProfiler();
    });
