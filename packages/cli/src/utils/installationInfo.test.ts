...
import { isGitRepository } from '@xtread-code/xtread-core';
...
describe('getInstallationInfo', () => {
  ...
  it('should detect Homebrew installation via execSync', () => {
    ...
    expect(mockedExecSync).toHaveBeenCalledWith(
      'brew list -1 | grep -q "^xtread-code$"',
      { stdio: 'ignore' },
    );
  ...
  it('should detect global pnpm installation', () => {
    const pnpmPath = `/Users/test/.pnpm/global/5/node_modules/.pnpm/some-hash/node_modules/@xtread-code/xtread/dist/index.js`;
    ...
    expect(info.isGlobal).toBe(true);
    expect(info.updateCommand).toBe('pnpm add -g @xtread-code/xtread@latest');
  ...
  it('should detect global yarn installation', () => {
    const yarnPath = `/Users/test/.yarn/global/node_modules/@xtread-code/xtread/dist/index.js`;
    ...
    expect(info.updateCommand).toBe(
      'yarn global add @xtread-code/xtread@latest',
    );
    expect(info.updateMessage).toContain('Attempting to automatically update');
  ...
  it('should detect global bun installation', () => {
    ...
    expect(info.isGlobal).toBe(true);
    expect(info.updateCommand).toBe('bun add -g @xtread-code/xtread@latest');
    expect(info.updateMessage).toContain('Attempting to automatically update');
  ...
  it('should default to global npm installation for unrecognized paths', () => {
    ...
    expect(info.isGlobal).toBe(true);
    expect(info.updateCommand).toBe(
      'npm install -g @xtread-code/xtread@latest',
    );
    expect(info.updateMessage).toContain('Attempting to automatically update');
