...
export const getLatestGitHubRelease = async (
  ...
  try {
    ...
    const endpoint = `https://api.github.com/repos/QwenLM/xtread-code-action/releases/latest`;
    ...
    debugLogger.debug(
      `Failed to determine latest xtread-code-action release:`,
      _error,
    );
    throw new Error(
      `Unable to determine the latest xtread-code-action release on GitHub.`,
    );
  }
};
