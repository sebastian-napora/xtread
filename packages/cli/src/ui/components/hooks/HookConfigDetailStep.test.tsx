...
describe('HookConfigDetailStep', () => {
  const createMockHookEvent = (): HookEventDisplayInfo => ({
    ...
    shortDescription: 'Right before XtreaD concludes its response',
    description: '',
    exitCodes: [
  ...
  it('should render source for Extensions with path', () => {
    ...
    const hookConfig = createMockHookConfig(
      ...
      'ralph-wiggum',
      '/Users/test/.xtread/extensions/ralph-wiggum',
    );
    ...
    expect(lastFrame()).toContain('/Users/test/.xtread/extensions/ralph-wiggum');
  });
