...
import { XtreadOAuthProgress } from './XtreadOAuthProgress.js';
import { useKeypress } from '../hooks/useKeypress.js';
import type { Key } from '../contexts/KeypressContext.js';

/**
 * DeviceAuthorizationData interface for testing (matching the component's internal type).
 */
...
describe('XtreadOAuthProgress', () => {
  ...
  describe('Timer functionality', () => {
    ...
    it('should use default 300 second timeout when deviceAuth is null', () => {
      const { lastFrame } = render(
        <XtreadOAuthProgress onTimeout={mockOnTimeout} onCancel={mockOnCancel} />,
      );
