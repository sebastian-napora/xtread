...
import type { Config, FileSearch } from '@xtread-code/xtread-core';
import { FileSearchFactory, escapePath } from '@xtread-code/xtread-core';
    ...
    const initialize = async () => {
      try {
        const searcher = FileSearchFactory.create({
          ...
          useQwenignore:
            config?.getFileFilteringOptions()?.respectXtreadIgnore ?? true,
          cache: true,
