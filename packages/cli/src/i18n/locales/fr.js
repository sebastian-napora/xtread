...
// Traductions françaises pour Xtread Code CLI
...
export default {
  ...
  'List available Xtread Code tools. Usage: /tools [desc]':
    'Lister les outils Xtread Code disponibles. Utilisation : /tools [desc]',
  'List available skills.': 'Lister les compétences disponibles.',
  'Available Xtread Code CLI tools:': 'Outils Xtread Code CLI disponibles :',
  ...
  'open full Xtread Code documentation in your browser':
    'ouvrir la documentation complète de Xtread Code dans votre navigateur',
  ...
  // ============================================================================
  'Project Level (.xtread/agents/)': 'Niveau projet (.xtread/agents/)',
  'User Level (~/.xtread/agents/)': 'Niveau utilisateur (~/.xtread/agents/)',
  ...
  'Generate with Xtread Code (Recommended)':
    'Générer avec Xtread Code (Recommandé)',
  ...
  'View and edit Xtread Code settings':
    'Voir et modifier les paramètres de Xtread Code',
  Settings: 'Paramètres',
  'To see changes, Xtread Code must be restarted. Press r to exit and apply changes now.':
    'Pour voir les changements, Xtread Code doit être redémarré. Appuyez sur r pour quitter et appliquer les changements maintenant.',
  ...
  'Respect .xtreadignore': 'Respecter .xtreadignore',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with Xtread Code.':
    'Vous installez une extension depuis {{originSource}}. Certaines fonctionnalités peuvent ne pas fonctionner parfaitement avec Xtread Code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run Xtread Code in one of these supported IDEs: VS Code or VS Code forks.':
    "L'intégration IDE n'est pas prise en charge dans votre environnement actuel. Pour utiliser cette fonctionnalité, exécutez Xtread Code dans l'un des IDEs pris en charge : VS Code ou ses dérivés.",
  ...
  // Commandes - Hooks
  // ============================================================================
  'Manage Xtread Code hooks': 'Gérer les hooks Xtread Code',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask Xtread Code.':
    'Ce menu est en lecture seule. Pour ajouter ou modifier des hooks, éditez settings.json directement ou demandez à Xtread Code.',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask Xtread Code.':
    'Pour réactiver les hooks, supprimez "disableAllHooks" de settings.json ou demandez à Xtread Code.',
  Project: 'Projet',
  User: 'Utilisateur',
  System: 'Système',
  Extension: 'Extension',
  ...
  'Right before Xtread Code concludes its response':
    'Juste avant que Xtread Code conclue sa réponse',
  ...
  'Generate a project summary and save it to .xtread/PROJECT_SUMMARY.md':
    "Générer un résumé du projet et l'enregistrer dans .xtread/PROJECT_SUMMARY.md",
  ...
  "Xtread Code won't ask before using allowed tools.":
    "Xtread Code ne demandera pas avant d'utiliser les outils autorisés.",
  'Xtread Code will ask before using these tools.':
    "Xtread Code demandera avant d'utiliser ces outils.",
  'Xtread Code is not allowed to use denied tools.':
    "Xtread Code n'est pas autorisé à utiliser les outils refusés.",
  ...
  'Saved in .xtread/settings.local.json':
    'Enregistré dans .xtread/settings.local.json',
  'Project settings': 'Paramètres du projet',
  'Checked in at .xtread/settings.json': 'Validé dans .xtread/settings.json',
  'User settings': 'Paramètres utilisateur',
  'Saved in at ~/.xtread/settings.json': 'Enregistré dans ~/.xtread/settings.json',
  ...
  'Xtread Code can read files in the workspace, and make edits when auto-accept edits is on.':
    "Xtread Code peut lire les fichiers dans l'espace de travail et effectuer des modifications lorsque l'acceptation automatique est activée.",
  'Xtread Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    "Xtread Code pourra lire les fichiers dans ce répertoire et effectuer des modifications lorsque l'acceptation automatique est activée.",
  ...
  'You can run any shell commands from Xtread Code using ! (e.g. !ls).':
    "Vous pouvez exécuter n'importe quelle commande shell depuis Xtread Code en utilisant ! (ex. !ls).",
  ...
  "Set up Xtread Code's status line UI":
    "Configurer l'interface de la barre de statut de Xtread Code",
};
